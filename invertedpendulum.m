...
%Response of Pendulum Position to an Impulse Disturbance under PID Control: Kp = 1, Ki = 1, Kd = 1
Kp = 1;
Ki = 1;
Kd = 1;
C = pid(Kp,Ki,Kd);
...
%Response of Pendulum Position to an Impulse Disturbance under PID Control:
%Kp = 100, Ki = 1, Kd = 20
Kp = 100;
Ki = 1;
Kd = 20;
